...
namespace egbt22lib
{
    public static class Transformation
    {
        ...
        public static (double x, double y, double z) Etrs89ToDbrefInv(double x, double y, double z)
        {
            return rotateReverse(RotationMatrix_ETRS892DBRef,
                scaleReverse(Scale_ETRS892DBRef,
                translateReverse(Param_ETRS892DBRef, (x, y, z))));
        }
